...
$(document).ready(function(){
    ...
    if(blockNum > 0) //If not the genesis block..
    {
        ...
        $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+blockNum+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="prevHash"><b>Block Height: </b><br />'+blockNum+'</span><br /><span class="blockTimeAdded"><b>Created: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*block.transactions.length))+'"></input></div>');
		...
		blk.transactions = blk.transactions || [];
                ...
                if (block.transactions) {
                    ...
                    $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum-i)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="prevHash"><b>Block Height: </b><br />'+(blockNum-i)+'</span><br /><span class="blockTimeAdded"><b>Created: </b><br />'+timeConverter(blk.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*blk.transactions.length))+'"></input></div>');
                }
            ...
            else if(blockNum - i == 0) //If genesis block..
            {
                ...
                $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum-i)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="prevHash"><b>Block Height: </b><br />'+(blockNum-i)+'</span><br /><span class="blockTimeAdded"><b>Created: </b><br />'+timeConverter(blk.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br /><br /><span class="blocksTransactionsHdr" >Transactions:</span><br /><span class="blocksTransactions">No transactions in the Genesis block.</span></div><input type="hidden" class="height" value="'+270+'"></input></div>');
            }
            else
            {
                break;
    ...
    else
    {
        ...
        $('#blockScroll').prepend('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+blockNum+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="prevHash"><b>Block Height: </b><br />'+(blockNum-i)+'</span><br /><span class="blockTimeAdded"><b>Created: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+270+'"></input></div>');
    }
...
function updatePage()
{
    ...
    if(storeBlock < blockNum) //If latest block number is less than chain height
    {
        ...
        $('#blockScroll').append('<div class="singleBlockContainer"><div class="exBlock notClicked" onclick="changeShape(this)"><span>'+(blockNum)+'</span></div><br /><div class="triangle_down_big"></div><div class="triangle_down"></div><div class="blockData"><span class="prevHash"><b>Block Height: </b><br />'+(blockNum)+'</span><br /><span class="blockTimeAdded"><b>Created: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans+'</div><input type="hidden" class="height" value="'+(351+(39*block.transactions.length))+'"></input></div>');
...
function getBlockData(number, el)
{
    ...
    if(number === 0)
    {
        ...
        $(el).html('<span class="prevHash" style="display:inline-block"><b>Block Height: </b><br />'+0+'</span><br /><span class="blockTimeAdded"  style="display:inline-block"><b>Created: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br /><br /><span style="display:inline-block" class="blocksTransactionsHdr" >Transactions:</span><br /><span class="blocksTransactions" style="display:inline-block">No transactions in the Genesis block.</span>');
    ...
    else
    {
        ...
        $(el).html('<span class="prevHash" style="display:inline-block"><b>Block Height: </b><br />'+block.previousBlockHash+'</span><br /><span class="blockTimeAdded"  style="display:inline-block"><b>Created: </b><br />'+timeConverter(block.nonHashData.localLedgerCommitTimestamp.seconds)+'</span><br />'+transSpans);
        $(el).css('text-align', 'left');
