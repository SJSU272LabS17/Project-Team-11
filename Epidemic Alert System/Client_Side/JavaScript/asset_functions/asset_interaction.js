...
function createAsset()
{
    ...
    $('#loaderMessages').html('<u>Creating Template</u><br /><br /><span id="messages"></i>waiting...</i></span><br /></div>&nbsp;');
    ...
    xhr.onprogress = function () {
        ...
        for(let i = 0; i < array.length; i++)
		{
            if(array[i] != '')
			{
			    ...
			    alert("ASSSSSSEEEEEEEEEETTTTTTTTTT : "+array[i].message);
    ...
    xhr.onreadystatechange = function (){
        if(xhr.readyState === 4)
		{
            ...
            else
			{
                ...
                $('#confTxt').html('Created Template: '+ JSON.parse(array[array.length - 1]).v5cID);
            }
        }
    };
...
function updateAsset(vin, make, model, colour, reg, v5cID, el)
{
	...
	*/
	...
	{
         if(bigData[i].title=='VIN')
         {
           newTitle='PIN';
	 }
	if(bigData[i].title=='Make')
         {
           newTitle='Zip Code';
	 }
	if(bigData[i].title=='Model')
         {
           newTitle='Symptoms';
	 }
	if(bigData[i].title=='Colour')
         {
           newTitle='Medicines';
	 }
	if(bigData[i].title=='Registration')
         {
           newTitle='Disease Name';
	 }
          
    		
        spans += '<div class="loaderSpan" id="span'+(i+1)+'"><u>'+newTitle+'</u><br /><br /><span id="msg'+(i+1)+'Part1"></i>waiting...</i></span><br /><span id="msg'+(i+1)+'Part2"></span><br /><span id="msg'+(i+1)+'Part3"></span><br /><span id="msg'+(i+1)+'Part4"></span><br /></div>&nbsp;';
    }
